        ...
        dbc.Nav(
            [ # connecting the app.py file to all the other files
              # that we want in the sidebar
                ...
                dbc.NavLink("Static Plots ", href="/page-1", active="exact"),
                dbc.NavLink("Monster Scatter Plot ", href="/page-2", active="exact"),
                dbc.NavLink("Monster Box Plot", href="/page-3", active="exact"),
